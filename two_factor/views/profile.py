...
from ..models import get_available_phone_methods, get_available_email_methods
from ..utils import backup_phones, default_device, backup_emails
...
class ProfileView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        return {
            ...
            'backup_emails': backup_emails(self.request.user),
            'backup_tokens': backup_tokens,
            'available_phone_methods': get_available_phone_methods(),
            'available_email_methods': get_available_email_methods()
        }
